...
const FinanceAgro = lazy(() => import('./pages/FinanceAgro'));
...
function PageLoader() {
  return (
    <div style={{
      ...
      <div className="dashboard-spinner" style={{ width: 40, height: 40 }} />
      ...
      <div>
        ...
        <div className="fcl">
          {t.footer.sectorLinks.map((link, i) => (
            <a key={i} href="#secteurs" className={link === t.footer.sectorLinks[5] ? 'soon-link' : ''}>
              {link}
...
function AppContent() {
  ...
  // Nav scroll effect with passive listener for performance
  useEffect(() => {
    const handleScroll = () => {
